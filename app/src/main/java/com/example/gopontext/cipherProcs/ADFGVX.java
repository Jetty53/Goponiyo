...
//            int found = 0;
//            int chi = charToNum(input.charAt(x));
//            for (int row = 0; row < 6; row++) {
//                for (int col = 0; col < 6; col++) {
...
//        k = 0;
//        int keyArrLength;
//        if (afterMat.length <= key.length()) {
//            keyArrLength = afterMat.length;
//        } else {
//            keyArrLength = key.length();
//        }
//
...
//            str.append(numToCipherChar(resArr[i]));
//        }
//
//        return str.toString();
        StringBuilder str = new StringBuilder();
        ...
        for (int row = 0; row < 6; row++) {
            for (int col = 0; col < 6; col++) {
                ...
                //System.out.println("CharTONum(PREV): "+charToNum(matrix.charAt(k)));

//                if (37 <= charToNum(matrix.charAt(k)) && charToNum(matrix.charAt(k)) <= 62) {
//                    charSquare[row][col] = charToNum(matrix.charAt(k)) - 26;
//                } else if (1 <= charToNum(matrix.charAt(k)) && charToNum(matrix.charAt(k)) <= 36) {
//                    charSquare[row][col] = charToNum(matrix.charAt(k));
//                }

                charSquare[row][col] = charToNum(matrix.charAt(k));

//                System.out.println("CharTONum(POST): "+charSquare[row][col]);
//                System.out.println();
...
//            if (37 <= charToNum(input.charAt(x)) && charToNum(input.charAt(x)) <= 62) {
//                chi = charToNum(input.charAt(x)) - 26;
//            } else {
...
//            if (37 <= charToNum(matrix.charAt(k)) && charToNum(matrix.charAt(k)) <= 62) {
//                keyArr[i] = charToNum(key.charAt(i)) - 26;
//            } else if (1 <= charToNum(matrix.charAt(k)) && charToNum(matrix.charAt(k)) <= 36) {
//                keyArr[i] = charToNum(key.charAt(i));
//            }
...
//        int keyArrLength;
//
//        if (inputCipher.length() <= key.length()) {
//            keyArrLength = inputCipher.length();
//        } else {
//            keyArrLength = key.length();
//        }
//        int[] keyArr = new int[keyArrLength];
...
//        int loc = 0;
//        for (int i = 0; i < sortedIndexKey.length; i++) {
//            if (sortedIndexKey[i] < (inputCipher.length() % keyArr.length)) {
//                for (int j = k; j < k + (inputCipher.length() / keyArr.length) + 1; j++) {
//                    array[j] = sortedIndexKey[i];
//                    loc = j;
//                }
//            } else if (sortedIndexKey[i] >= (inputCipher.length() % keyArr.length)) {
...
//        }
//
//        if (noSpclChar == 1 & plainText != null && plainText.length() % 2 == 0){
//            decodedText.append(decodeADFGVX(plainText, matrixPat, keyText));
//        }
//
...
//        return decode;
        ...
        for (int i = 0; i < encode.length(); i++) {
            ...
            //encode.charAt(i) == 'B' || encode.charAt(i) == 'C' ||  encode.charAt(i) == 'E' || encode.charAt(i) == 'H' || encode.charAt(i) == 'I' || encode.charAt(i) == 'J' || encode.charAt(i) == 'K' || encode.charAt(i) == 'L' || encode.charAt(i) == 'M' || encode.charAt(i) == 'N' || encode.charAt(i) == 'O' || encode.charAt(i) == 'P' || encode.charAt(i) == 'Q' || encode.charAt(i) == 'R' || encode.charAt(i) == 'S' || encode.charAt(i) == 'T' || encode.charAt(i) == 'U' || encode.charAt(i) == 'W' || encode.charAt(i) == 'Y' || encode.charAt(i) == 'Z' ||
        ...
        //System.out.println("NOSPCLCHAR: "+noSpclChar);
        //System.out.println("Plain Txt: "+plainText);
        //assert plainText != null;
        //System.out.println("PlainText length: "+plainText.length() % 2);
