...
public class AUTOKEY {
    private String encodeDecodeAUTOKEY(String inputText, String keyText, int status){
        ...
        if (secInputText.length() < keyText.length()){



            if (status == 1){
                for (int i = 0; i < secInputText.length(); i++){
                    cipCharInt = (charToNum(keyText.charAt(i)) + charToNum(secInputText.charAt(i))) % 26;
                ...
                for (int i = 0; i < secInputText.length(); i++){
                    ...
                    cipCharInt = (charToNum(secInputText.charAt(i)) - charToNum(keyText.charAt(i))) % 26;
            ...
            if (status == 1){
                for (int i = 0; i < secInputText.length(); i++){
                    ...
                    if (i < keyText.length()){
                        ...
                        cipCharInt = (charToNum(secInputText.charAt(k)) + charToNum(secInputText.charAt(i))) % 26;
                ...
                for (int i = 0; i < secInputText.length(); i++){
                    ...
                    if (i < keyText.length()){
                        ...
                        cipCharInt = (charToNum(secInputText.charAt(i)) - charToNum(str1.toString().charAt(k))) % 26;
                        cipCharInt = (cipCharInt < 0) ? cipCharInt + 26 : cipCharInt;
    ...
    public String encodeProcedureAUTOKEY(String inputText, String keyText){
        return encodeDecodeAUTOKEY(inputText, keyText, 1);
    }

    public String decodeProcedureAUTOKEY(String inputText, String keyText){
        return encodeDecodeAUTOKEY(inputText, keyText, 2);
    }
